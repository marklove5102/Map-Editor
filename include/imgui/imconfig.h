...
//-----------------------------------------------------------------------------
// A) You may edit imconfig.h (and not overwrite it when updating Dear ImGui, or maintain a patch/rebased branch with
...
//-----------------------------------------------------------------------------
// You need to make sure that configuration settings are defined consistently _everywhere_ Dear ImGui is used, which
...
// gets to see the same data structure layouts. Call IMGUI_CHECKVERSION() from your .cpp file to verify that the data
...
// - Windows DLL users: heaps and globals are not shared across DLL boundaries! You will need to call
...
// code of obsolete function/names. #define IMGUI_DISABLE_OBSOLETE_FUNCTIONS

//---- Disable all of Dear ImGui or don't implement standard windows/tools.
// It is very strongly recommended to NOT disable the demo windows and debug tool during development. They are extremely
// useful in day to day work. Please read comments in imgui_demo.cpp.
...
// ShowDemoWindow()/ShowStyleEditor() will be empty. #define IMGUI_DISABLE_DEBUG_TOOLS                         //
// Disable metrics/debugger and other debug tools: ShowMetricsWindow(), ShowDebugLogWindow() and ShowIDStackToolWindow()
// will be empty.
...
// the default). #define IMGUI_DISABLE_DEFAULT_SHELL_FUNCTIONS             // Don't implement default
// platform_io.Platform_OpenInShellFn() handler (Win32: ShellExecute(), require shell32.lib/.a, Mac/Linux: use
// system("")). #define IMGUI_DISABLE_DEFAULT_FORMAT_FUNCTIONS            // Don't implement
...
// avoid linking with them. You will need to call ImGui::SetAllocatorFunctions(). #define IMGUI_DISABLE_DEFAULT_FONT //
...
// #define IMGUI_ENABLE_TEST_ENGINE                          // Enable imgui_test_engine hooks. Generally set
// automatically by include "imgui_te_config.h", see Test Engine for details.
